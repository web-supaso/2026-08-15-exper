import { LocalPartner } from '../types';
...
export const localPartners: LocalPartner[] = [
  {
    ...
    description: {
      ...
      fr: "Fromages bio artisanaux fabriqués à partir de lait de brebis de haute montagne.",
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Astrophysiciens locaux guidant des séances d'observation céleste et de photographie.",
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Spécialistes de la biodiversité guidant l'observation des rapaces et de la faune marine.",
